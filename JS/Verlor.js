		  ...
		  '<div class="modal-dialog">'+
			'<div class="modal-content">'+
			  ...
			  '<div class="modal-footer">'+
				'<button type="button" id="same" class="btn btn-info" data-dismiss="modal">Rejouer cette carte</button>'+
				'<button type="button" id="next" class="btn btn-info" data-dismiss="modal">Nouvelle partie</button>'+
			  '</div>'+
			'</div>'+
		  '</div>'+
		'</div>';
...
function win(){
	game_over = true;
	show_modal('modal_win','Vous avez gagné !');
}
